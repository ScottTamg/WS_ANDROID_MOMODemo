...
import com.tttrtclive.test.TestDialog;
...
public class SplashActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        ((Switch) findViewById(R.id.switch_265)).setOnCheckedChangeListener((buttonView, isChecked) -> {
            mIsEnableH265 = isChecked;
        });
    ...
    public void onClickEnterButton(View v) {
        ...
        //TODO 以下代码发布时删除
        TestUtils.setAddressAndPushUrl(mIsEnableH265);

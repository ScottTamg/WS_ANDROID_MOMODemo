...
public final class WebRtcAudioUtils {
    ...
    private static final String[] BLACKLISTED_VOICE_COMMUNICATION=new String[]{
            "SM801",
            "MI 6",
    };
    ...
    public static List<String> getBlackListedVoiceCommunication() {
        return Arrays.asList(WebRtcAudioUtils.BLACKLISTED_VOICE_COMMUNICATION);
    }

    public static boolean isBlackListedVoiceCommunication(){
        List<String> blacklist=getBlackListedVoiceCommunication();
